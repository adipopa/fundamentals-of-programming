...
grade_repository.add(Grade(9, 3, 8))
grade_repository.add(Grade(3, 8, None))
grade_repository.add(Grade(8, 6, None))
grade_repository.add(Grade(4, 6, None))
grade_repository.add(Grade(7, 3, 10))
grade_repository.add(Grade(7, 2, None))
grade_repository.add(Grade(7, 6, 7))
